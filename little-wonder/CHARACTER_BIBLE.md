...
## ١ج. قاعدة اتجاه الكادر (خط الحركة)

> **الشخصية تبقى في نفس جهة الشاشة في كل لقطات المشهد الواحد.**

لو نونو يسار الكادر في لقطة، لازم تبقى يسار في كل اللقطات اللي بعدها في نفس المشهد. ولو انعكست، المشاهد يحس إنها انتقلت مكان ثاني.

**في مشهد المرجيحة (الحلقة 1):**
- **نونو** = يسار الكادر دايمًا · المقعد الأحمر على **يمينها** · تلتفت **يمين** تكلم نادية.
- **نادية** = يمين الكادر دايمًا · المقعد الأحمر على **يسارها** · تلتفت **يسار** تكلم نونو.

**وحيلة مفيدة للقطات الحوار:** بدل ما نحط الشخصيتين في الكادر (وهذا يسبب تداخل)، نخلي وحدة كاملة في الكادر و**يد الثانية بس** داخلة من طرف الكادر تمسك نفس الشي. كذا يبين إن فيه شد من الجهتين، وبنفس الوقت ما فيه إلا وجه واحد = ما فيه خطأ هوية.

```
only a child's HAND and forearm reach in from the far RIGHT edge of frame —
that other child's face and body are OUTSIDE the frame and never seen
```
...
(قِسنا منه الأرقام التالية — أي لقطة جاية لازم تطابقه).

### الأبعاد المطلقة
| القياس | الرقم المقفول |
|---|---|
| قاعد — من طرف الأذن للعشب | **32 سم** |
| واقف على أربع — ارتفاع الكتف | **26 سم** |
| طول الجسم من الأنف لأصل الذيل | **45 سم** |
| العرض (قط سمين) | **22 سم** |

### النسبة لكل شخصية (لو كانوا على نفس بُعد الكاميرا)
| الشخصية | طولها | ميشو قاعد يوصل لـ | النسبة |
|---|---|---|---|
| تيتة خديجة | 158 سم | تحت ركبتها | 1 : 5 |
| زوزو (10) | 138 سم | تحت ركبتها | 1 : 4.3 |
| نونو (8) | 128 سم | **تحت ركبتها بشوي** | 1 : 4 |
| نادية (4) | 102 سم | فوق ركبتها بشوي | 1 : 3.2 |
| حور (سنتين) | 86 سم | نص فخذها | 1 : 2.7 |

### 🔑 المرساة الذهبية (استخدمها في كل لقطة فيها المرجيحة)
> **أطراف أذنَي ميشو وهو قاعد = مستوى سطح المقعد الأحمر**، إذا الاثنين على نفس العشب.

هذي أدق مرساة عندنا لأن ارتفاع المقعد عن الأرض (≈40 سم) **عمودي** — ما يتأثر بزاوية الكاميرا،
عكس عرض المقعد اللي يتغير مع المنظور. وقِسناها فعلياً من لقطة 46 وطلعت مطابقة.

### قاعدة الكادر
- في لقطة واسعة تملى فيها البنت الكادر طولياً: ميشو يأخذ **≈ ¼ ارتفاع الكادر**.
- **الحد الأقصى المطلق: ⅓ ارتفاع الكادر.** أكثر من كذا = خطأ ونعيد.

### ممنوعات (كل وحدة سبّبت لنا خطأ فعلي)
1. ❌ **ممنوع ميشو يمشي باتجاه الكاميرا** — هذا السبب الجذري لتضخّمه في لقطة 23 (كبر 1.5× داخل نفس اللقطة).
2. ❌ **ممنوع تشبيه حجمه بفاكهة أو غرض مو موجود بالكادر** — كتبنا "بحجم بطيخة" في 23 فرسم بطيخة حقيقية.
3. ❌ **ممنوع الاعتماد على كلمة "small" لحالها** — المشكلة في العمق مو في الصفة.
4. ✅ **لازم** تثبّت عمقه بجملة صريحة + تربط حجمه ببروب موجود بنفس الكادر.

### 📋 البلوك الإنجليزي — انسخه حرفياً في كل لقطة فيها ميشو
```
MISHOO's SIZE IS FIXED AND MUST NOT CHANGE AT ANY POINT IN THE SHOT.
He is a small chubby house cat: sitting upright, the very tips of his ears
reach only as high as the TOP SURFACE of the red swing seat. He is roughly
ONE QUARTER of NOONOO's height and reaches just BELOW HER KNEE.
He stays at a FIXED DISTANCE from the camera for the whole shot and NEVER
walks toward the camera and NEVER grows larger.
His whole body occupies about ONE QUARTER of the frame height and never more
than one third.
```
