...
- **الملف:** `audio/theme_song.mp3`
- **الرابط:** https://suno.com/s/LBdpQ1XD49P24CiP
- **المدة:** 33.62 ثانية
- **الإيقاع (مقاس من الملف):** 103.4 BPM — النبضة 0.58 ث، **المازورة (4 نبضات) = 2.32 ث**
- **أول نبضة:** 0.45 ث
- **عدد المازورات:** ~14

### شبكة المازورات (نقاط القص)

```
bar  1: 0.45    bar  6: 12.05    bar 11: 23.65
bar  2: 2.77    bar  7: 14.37    bar 12: 25.97
bar  3: 5.09    bar  8: 16.69    bar 13: 28.29
bar  4: 7.41    bar  9: 19.01    bar 14: 30.61
bar  5: 9.73    bar 10: 21.33    bar 15: 32.93
```

**كل قصّة بين لقطة ولقطة لازم تكون على وحدة من هالأرقام** — هذا اللي يخلي المقدمة تحس محترفة.

---

## تقطيع المشاهد (Storyboard)

10 لقطات، كل وحدة تغطي مازورة أو مازورتين.

| # | الوقت | المدة | المقطع | المشهد | المكان |
|---|---|---|---|---|---|
| 1 | 0.00–4.64 | 2 مازورة | "Hey hey, come and play!" | البوابة تنفتح، الكاميرا تدخل على الممر، ميشو يطل ويموء | HOUSE |
| 2 | 4.64–9.28 | 2 مازورة | "Little Wonder starts today!" | الكاميرا ترفع على البيت وقت الغروب، **عنوان Little Wonder يظهر** | HOUSE |
| 3 | 9.28–11.60 | 1 مازورة | "ZooZo's kind, she leads the way" | زوزو تمسك يد حور وتمشي فيها بهدوء | GARDEN |
| 4 | 11.60–13.92 | 1 مازورة | "NooNo's got ideas to play" | نونو تطلع فكرة، تشير بيدها بحماس | GARDEN |
| 5 | 13.92–16.24 | 1 مازورة | "Nadiah asks a hundred whys" | نادية ترفع يدها وتسأل بفضول | GARDEN |
| 6 | 16.24–18.56 | 1 مازورة | "Little Hoor waves up so high!" | حور تلوّح للكاميرا بيدها الصغيرة وهي تضحك | GARDEN |
| 7 | 18.56–23.20 | 2 مازورة | "Grandma Khadija, warm and wise" | تيتة على درج البيت تفتح يديها، البنات يركضون لحضنها | HOUSE |
| 8 | 23.20–25.52 | 1 مازورة | "Mishoo the cat with big round eyes!" | لقطة قريبة لميشو، عيونه الكبيرة، يميل راسه ويموء | LIVING ROOM |
| 9 | 25.52–30.16 | 2 مازورة | "Little Wonder, Little Wonder" | الكل يرقص في الحديقة، ميشو يطيح من المرجيحة ويضحك | GARDEN |
| 10 | 30.16–33.62 | ~1.5 مازورة | "Every day's a brand new wonder!" | الكل ينظرون للكاميرا ويبتسمون، **العنوان يظهر ويثبت** | GARDEN |

> ⚠️ **تنبيه:** شبكة المازورات **مقاسة من الملف الصوتي** (دقيقة).
> أما **توزيع الأسطر على المازورات فهو تقدير** — ما قدرت أسمع الغناء، بنيته على المنطق الموسيقي.
> **لازم ميثم يسمع الأغنية ويأكد**: في أي ثانية يبدأ سطر زوزو؟ وسطر تيتة؟ وأول "Little Wonder"؟

**التكلفة:** 10 لقطات × 5 ثواني بـ Seedance Mini بدون صوت ≈ **50 كريدت**.
(نولّد 5 ثواني لكل لقطة ونقصّها في المونتاج للمدة المطلوبة — يعطينا هامش أمان.)
...
1. ✅ الأغنية جاهزة.
2. ⏳ ميثم يأكد توقيت الأسطر بالسمع.
3. نولّد الـ 10 لقطات **بدون صوت** (`generate_audio: false` — أرخص، والأغنية تغطي المقدمة كلها).
4. نركّب اللقطات على الأغنية، والقص على شبكة المازورات فوق.
